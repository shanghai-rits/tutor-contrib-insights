...
config = {
    "add": {
        ...
        "INSIGHTS_ANALYTICSAPI_OAUTH2_SECRET": "{{ 8|random_string }}",
        "BACKEND_OAUTH2_SECRET": "{{ 8|random_string }}",
        "INSIGHTS_ANALYTICSAPI_BACKEND_OAUTH2_SECRET": "{{ 8|random_string }}",
        "SEGMENT_WRITE_KEY": "{{ 20|random_string }}",
    },
    "defaults": {
        "VERSION": __version__,
        "DOCKER_IMAGE": "{{ DOCKER_REGISTRY }}edxops/insights:latest",
        "INSIGHTS_ANALYTICSAPI_DOCKER_IMAGE": "{{ DOCKER_REGISTRY }}edxops/analytics_api:latest",
        "HOST": "insights.{{ LMS_HOST }}",
        "INSIGHTS_ANALYTICSAPI_HOST": "analyticsapi.{{ LMS_HOST }}",
        "INDEX_OVERRIDES": {},
        "DASHBOARD_MYSQL_DATABASE": "dashboard",
        "INSIGHTS_ANALYTICSAPI_MYSQL_DATABASE": "analytics-api",
        "REPORTS_MYSQL_DATABASE": "reports",
        "MYSQL_USER": "analytics001",
        "INSIGHTS_ANALYTICSAPI_MYSQL_USER": "api001",
        "OAUTH2_KEY": "insights-sso-key",
        "BACKEND_OAUTH2_KEY": "insights-backend-service-key",
        "INSIGHTS_ANALYTICSAPI_OAUTH2_KEY": "analytics_api-sso-key",
        "INSIGHTS_ANALYTICSAPI_BACKEND_OAUTH2_KEY": "analytics_api-backend-service-key",
        "CACHE_REDIS_DB": "{{ OPENEDX_CACHE_REDIS_DB }}",
        "ELASTICSEARCH_INDEX": "learner",
        "ELASTICSEARCH_UPDATE_INDEX": "index_update",
        "INSIGHTS_ANALYTICSAPI_COURSE_BLOCK_API": "",
    },
}
