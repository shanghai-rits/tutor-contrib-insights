...
ANALYTICS_DATABASE_V1 = '{{ INSIGHTS_REPORTS_MYSQL_DATABASE }}_v1'
...
MEDIA_URL = 'http://{{ INSIGHTS_ANALYTICSAPI_HOST }}/static/reports/'
...
#     }
# }
SOCIAL_AUTH_EDX_OAUTH2_KEY = "{{ INSIGHTS_ANALYTICSAPI_OAUTH2_KEY }}"
SOCIAL_AUTH_EDX_OAUTH2_SECRET = "{{ INSIGHTS_ANALYTICSAPI_OAUTH2_SECRET }}"
SOCIAL_AUTH_EDX_OAUTH2_ISSUER = "http://lms:8000"
SOCIAL_AUTH_EDX_OAUTH2_URL_ROOT = "http://lms:8000"
SOCIAL_AUTH_EDX_OAUTH2_LOGOUT_URL = "http://lms:8000/logout"

BACKEND_SERVICE_EDX_OAUTH2_KEY = "{{ INSIGHTS_ANALYTICSAPI_BACKEND_OAUTH2_KEY }}"
BACKEND_SERVICE_EDX_OAUTH2_SECRET = "{{ INSIGHTS_ANALYTICSAPI_BACKEND_OAUTH2_SECRET }}"
...
SOCIAL_AUTH_EDX_OIDC_KEY = "{{ INSIGHTS_ANALYTICSAPI_OAUTH2_KEY }}"
SOCIAL_AUTH_EDX_OIDC_SECRET = "{{ INSIGHTS_ANALYTICSAPI_OAUTH2_SECRET }}"
SOCIAL_AUTH_EDX_OIDC_URL_ROOT = 'http://lms:8000/oauth2'
SOCIAL_AUTH_EDX_OIDC_LOGOUT_URL = 'http://lms:8000/logout'
SOCIAL_AUTH_EDX_OIDC_ID_TOKEN_DECRYPTION_KEY = "{{ INSIGHTS_ANALYTICSAPI_OAUTH2_SECRET }}"
